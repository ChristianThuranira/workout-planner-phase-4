...
with app.app_context():
    ...
    if not User.query.first():
        ...
        user1 = User(username='john_doe', email='Chris@example.com', password='password123')
        user2 = User(username='jane_doe', email='Mike@example.com', password='password123')
        user3 = User(username='john_doe', email='Feb@example.com', password='password123')
        user4 = User(username='jane_doe', email='valentine@example.com', password='password123')
